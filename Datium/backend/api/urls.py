...
urlpatterns = [
    ...
    path('systems/<int:pk>/export-sql', views.system_export_sql_view),
    ...
    path('invitations/<int:pk>/respond', views.respond_invitation_view),
    path('notifications', views.user_notifications_view),
    path('notifications/read', views.mark_notifications_read_view),
