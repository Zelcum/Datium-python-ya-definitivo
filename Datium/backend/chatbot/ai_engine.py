...
def build_system_prompt(*, user: User, system_id: Optional[int], user_message: str, file_context: str = "") -> str:
    ...
    focus_rule = ""
    if system_id:
        focus_rule = f"El sistema activo actual es ID {system_id}. NUNCA uses la acción 'create_system'. Toda nueva tabla va obligatoriamente dentro de este sistema activo usando la acción 'create_table' con 'systemId': {system_id}."
    else:
        focus_rule = "No hay un sistema activo seleccionado en la interfaz (es GLOBAL). Si el usuario pide crear una tabla, primero debes crear un sistema o requerir el systemId si ya existe."
    ...
    return (
        ...
        f"FOCO_SISTEMA_ACTIVO: {system_id if system_id else 'GLOBAL (Ninguno)'}\n"
        f"{focus_rule}\n"
        "\n"
        "REGLAS ESTRICTAS:\n"
        ...
        "- Si propones crear, editar o eliminar algo, debes incluir al final un bloque JSON válido de esta forma exacta:\n"
        "```json\n"
        "{\n"
        "  \"confirmation_required\": true,\n"
        "  \"summary\": \"Resumen de lo que se va a hacer\",\n"
        "  \"actions\": [\n"
        "    {\n"
        ...
        "}\n"
        "```\n"
        "- El JSON va estrictamente al final, después de tu mensaje descriptivo.\n"
        "\n"
        "ESPECIFICACIÓN DE ACCIONES Y SUS PAYLOADS REQUERIDOS (USA ESTE FORMATO EXACTO, RESPETA MAYÚSCULAS/MINÚSCULAS):\n"
        "1. create_system:\n"
        "   payload: { \"name\": \"Nombre\", \"description\": \"Desc\", \"imageUrl\": \"url_opcional\", \"securityMode\": \"none\"|\"password\", \"generalPassword\": \"pwd_opcional\", \"tables\": [ ...tablas_opcionales... ] }\n"
        "2. update_system:\n"
        "   payload: { \"systemId\": int, \"name\": \"Nombre\", \"description\": \"Desc\", ...otros_campos... }\n"
        "3. delete_system:\n"
        "   payload: { \"systemId\": int }\n"
        "4. list_tables:\n"
        "   payload: { \"systemId\": int }\n"
        "5. create_table:\n"
        "   payload: { \"systemId\": int, \"name\": \"Nombre de Tabla\", \"description\": \"Desc\", \"fields\": [ { \"name\": \"nombre_campo\", \"type\": \"text\"|\"number\"|\"date\"|\"boolean\"|\"select\"|\"relation\", \"isPrimaryKey\": bool, \"required\": bool, \"is_unique\": bool, \"relatedTableId\": int|str_nombre_tabla } ] }\n"
        "   * NOTA: Es obligatorio incluir \"systemId\" (el ID del sistema donde se creará). Si hay un FOCO_SISTEMA_ACTIVO, usa ese ID.\n"
        "6. update_table:\n"
        "   payload: { \"systemId\": int, \"tableId\": int, \"name\": \"Nuevo Nombre\", \"description\": \"Nueva Desc\", \"fields\": [ ...campos... ] }\n"
        "   * NOTA: Es obligatorio incluir \"systemId\" (ID del sistema al que pertenece la tabla) y \"tableId\" (ID de la tabla a modificar).\n"
        "7. delete_table:\n"
        "   payload: { \"systemId\": int, \"tableId\": int }\n"
        "   * NOTA: Requiere tanto \"systemId\" como \"tableId\".\n"
        "8. list_records:\n"
        "   payload: { \"tableId\": int }\n"
        "9. create_record:\n"
        "   payload: { \"tableId\": int, \"values\": { \"nombre_columna\": valor, ... } }\n"
        "10. update_record:\n"
        "    payload: { \"tableId\": int, \"recordId\": int, \"values\": { \"nombre_columna\": valor, ... } }\n"
        "11. delete_record:\n"
        "    payload: { \"tableId\": int, \"recordId\": int }\n"
        "12. export_table:\n"
        "    payload: { \"tableId\": int, \"format\": \"csv\"|\"xlsx\" }\n"
        "13. move_table:\n"
        "    payload: { \"tableId\": int, \"targetSystemId\": int }\n"
        "\n"
        f"{schema}\n"
        f"{real_data}\n"
